...
const WINDOWS_URL = 'https://github.com/hasin-codes/Z-Fushou/releases/download/v0.69.0/ZFushou-0.69.0-x64.exe'
const MACOS_URL = 'https://github.com/hasin-codes/Z-Fushou/releases/download/v0.69.0/ZFushou-0.69.0-arm64.dmg'
