...
const bentoItems: BentoItem[] = [
    {
        id: "main",
        title: "Speak naturally, work efficiently",
        description:
            "We've engineered a seamless voice-to-text experience that eliminates friction between thought and action. Hold a key, speak your mind, and watch your words appear instantly wherever you need them.",
        href: "#",
        feature: "spotlight",
        spotlightItems: [
    ...
    },
    {
        ...
        description:
            "Your API keys are protected with OS-level secure storage and AES-256 fallback encryption.",
        href: "#",
        feature: "typing",
        typingText:
            "import { navigator } from 'browser-apis';\n\nconst handleTranscriptionActions = async (id, text, onDelete, onClick) => {\n  // Clipboard copy logic\n  try {\n    await navigator.clipboard.writeText(text);\n    console.log(`✓ Transcription #${id} copied to clipboard`);\n    setTimeout(() => console.log(`⌛ Copy state reset for transcription #${id}`), 2000);\n  } catch {\n    console.warn(`✗ Copy failed — unable to write transcription #${id} to clipboard`);\n  }\n  // Optional click handler\n  if (typeof onClick === 'function') {\n    onClick(id);\n    console.log(`🖱️ Transcription #${id} clicked`);\n  }\n  // Optional delete handler\n  if (typeof onDelete === 'function') {\n    onDelete(id);\n    console.log(`🗑️ Transcription #${id} deleted`);\n  }\n};",
        size: "md",
                        ...
                        >
                            <div className="p-5">
                                ...
                                <p className="text-sm text-neutral-600 dark:text-neutral-400 tracking-tight mb-4">
                                    Interact with Z Fushou using natural voice. Experience seamless voice-driven
                                    transcription.
                                </p>
                                <AIInput_Voice />
                            </div>
